...
public class PO_View {
	...
	/**
	 * Aborta si en la página que esta cargandose aparece un texto correspondiente a la propiedad key en el idioma locale
	 * @param driver: apuntando al navegador abierto actualmente.
	 * @param text:
	 */
	
	static public void checkNotKey(WebDriver driver, String key, int locale) {
	...
	/**
	 * Aborta si en la página que esta cargandose aparece el elemento indicado
	 * @param driver: apuntando al navegador abierto actualmente.
	 * @param text:
	 */
	
	static public void checkNotElement(WebDriver driver, String text) {
